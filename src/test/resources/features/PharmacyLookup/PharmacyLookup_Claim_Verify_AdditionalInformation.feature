Feature: PharmacyLookup search verify Additional Information
  ...
  @Functional
  Scenario Outline: Verify Additional Information
    ...
    Examples: 
      | Category      | Result                                                           |
      | Pharmacy List | Pharmacy List^Pharmacy List PN3190001 read - Pharmacy is on list | 
