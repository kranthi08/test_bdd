Feature: PharmacyLookup Search verify Authorization Notes & History
  ...
  @Functional
  Scenario Outline: Verify Authorization Call Notes
    ...
    Then User verifies Notes & History details     
      ...
      | HistoryLastUpdated | <HistoryLastUpdated>|
      | HistoryLastUsed    | <HistoryLastUsed>   |
      
    Examples: 
      | Notes  | HistoryAdded | HistoryLastUpdated | HistoryLastUsed |  
      | Notes^ | Added^       | Last update^       | Last used^      |  
