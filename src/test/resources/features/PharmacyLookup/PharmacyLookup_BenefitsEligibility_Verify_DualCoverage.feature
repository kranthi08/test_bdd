Feature: PharmacyLookup Search verify Benefits and Eligibility Dual Coverage
  ...
  @Functional
  Scenario Outline: Verify Benefits and Eligibility Dual Coverage
    ...
    Examples: 
      | BeginDate   | Indicator  | ProcessDate   | 
      | Begin Date^ | Indicator^ | Process Date^ | 
