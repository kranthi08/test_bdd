Feature: PharmacyLookup Search verify Benefits and Eligibility Call Notes
  ...
  @Functional
  Scenario Outline: Verify Benefits and Eligibility Call Notes 
    ...
    Examples: 
      ...
      | I - MAC    | 1 - Resolved | Benefits/Eligibility Comment | Benefits/Eligibility Comment | Type^I - MAC | Status^1 - Resolved | 
