Feature: PharmacyLookup Search verify Formulary Call Notes
  ...
  @Functional
  Scenario Outline: Verify Formulary Call Notes 
    ...
    Examples: 
       ...
       | I - MAC    | 1 - Resolved | Formulary Comment | Formulary Comment    | Type^I - MAC | Status^1 - Resolved |
